...
const Schema: z.ZodType<Prisma.DiaryCreateNestedManyWithoutCategoriesInput> = z
  .object({
    create: z
      .union([
...
export const DiaryCreateNestedManyWithoutCategoriesInputObjectSchema = Schema;
