...
import { WishlistCategoryOrderByWithRelationInputObjectSchema } from './WishlistCategoryOrderByWithRelationInput.schema';
...
const Schema: z.ZodType<Prisma.WishlistItemOrderByWithRelationInput> = z
  .object({
    ...
    category: z
      .lazy(() => WishlistCategoryOrderByWithRelationInputObjectSchema)
      .optional(),
  })
  .strict();
