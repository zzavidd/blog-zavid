...
const Schema: z.ZodType<Prisma.NestedEnumWishlistVisibilityWithAggregatesFilter> =
  z
    .object({
...
export const NestedEnumWishlistVisibilityWithAggregatesFilterObjectSchema =
  Schema;
