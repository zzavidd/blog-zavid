...
const Schema: z.ZodType<Prisma.WishlistItemCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const WishlistItemCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
