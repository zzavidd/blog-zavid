...
const Schema: z.ZodType<Prisma.WishlistItemUpdateManyWithoutCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const WishlistItemUpdateManyWithoutCategoryNestedInputObjectSchema =
  Schema;
