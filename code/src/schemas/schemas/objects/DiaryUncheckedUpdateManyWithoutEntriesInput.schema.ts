...
const Schema: z.ZodType<Prisma.DiaryUncheckedUpdateManyWithoutEntriesInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const DiaryUncheckedUpdateManyWithoutEntriesInputObjectSchema = Schema;
