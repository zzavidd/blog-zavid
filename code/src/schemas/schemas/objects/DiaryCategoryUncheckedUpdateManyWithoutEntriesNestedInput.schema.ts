...
const Schema: z.ZodType<Prisma.DiaryCategoryUncheckedUpdateManyWithoutEntriesNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DiaryCategoryUncheckedUpdateManyWithoutEntriesNestedInputObjectSchema =
  Schema;
