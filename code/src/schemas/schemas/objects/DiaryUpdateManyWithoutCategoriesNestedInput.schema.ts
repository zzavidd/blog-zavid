...
const Schema: z.ZodType<Prisma.DiaryUpdateManyWithoutCategoriesNestedInput> = z
  .object({
    create: z
      .union([
...
export const DiaryUpdateManyWithoutCategoriesNestedInputObjectSchema = Schema;
