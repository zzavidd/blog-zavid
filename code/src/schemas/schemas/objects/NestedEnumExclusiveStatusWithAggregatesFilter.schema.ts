...
const Schema: z.ZodType<Prisma.NestedEnumExclusiveStatusWithAggregatesFilter> =
  z
    .object({
      ...
      not: z
        .union([
          z.lazy(() => ExclusiveStatusSchema),
          z.lazy(
            () => NestedEnumExclusiveStatusWithAggregatesFilterObjectSchema,
          ),
        ])
        .optional(),
      _count: z.lazy(() => NestedIntFilterObjectSchema).optional(),
      _min: z
        .lazy(() => NestedEnumExclusiveStatusFilterObjectSchema)
        .optional(),
      _max: z
        .lazy(() => NestedEnumExclusiveStatusFilterObjectSchema)
        .optional(),
...
export const NestedEnumExclusiveStatusWithAggregatesFilterObjectSchema = Schema;
