...
const Schema: z.ZodType<Prisma.WishlistItemUncheckedUpdateManyWithoutWishlistItemInput> =
  z
    .object({
      id: z
        .union([
...
export const WishlistItemUncheckedUpdateManyWithoutWishlistItemInputObjectSchema =
  Schema;
