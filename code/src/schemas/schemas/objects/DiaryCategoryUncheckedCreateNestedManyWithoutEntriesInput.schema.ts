...
const Schema: z.ZodType<Prisma.DiaryCategoryUncheckedCreateNestedManyWithoutEntriesInput> =
  z
    .object({
      create: z
        .union([
...
export const DiaryCategoryUncheckedCreateNestedManyWithoutEntriesInputObjectSchema =
  Schema;
