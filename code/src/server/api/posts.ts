...
export default class PostAPI {
  public static find(params: Prisma.PostWhereInput): Promise<Post> {
    return prisma.post.findFirstOrThrow({ where: params });
  }

  public static getLatestReverie(): Promise<Post> {
